<div class="slideout-manual" id="sm-wingbits">
        <header>
		  ...
		  <div id="page-title-center"><h1>Wingbits</h1></div>
		  <div id="page-title-right" onclick="menumanual('sm-wingbits')" class="slideout-manual-toggle"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fbfbfb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></div>
        </header>
		...
		<section id="slideout-body" style="width:100%;">
			...
			<header style="flex-direction: column;">
				...
				<div class="page-title"  style="display: flex; width:100%; margin-bottom:2rem; color:#fbfbfb80; font-size:0.75rem;">
					<div style="font-weight:600;">Release</div>&emsp;<div id="wingbits-release"></div>
				</div>
