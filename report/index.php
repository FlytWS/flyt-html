...
<header style="border-radius:0.75rem; display: flex;    flex-direction: column;    grid-gap: 1rem;    padding: 0;  ">

	<header id="panel-radio" class="large-panel-button" style="height: auto; width: 100%;    padding: 0;">
	<div style="font-size:1.4rem; padding:1.5rem; padding-top:2.5rem;  padding-bottom:0; color:#fbfbfb80;">Node</div>
	...
	<header id="panel-network" class="large-panel-button" style="height: auto; width: 100%;    padding: 0;">
	<div style="font-size:1.4rem; padding:1.5rem; padding-top:2.5rem;  padding-bottom:0; color:#fbfbfb80;">Radio</div>
	...
	<header id="panel-temperature" class="large-panel-button" style="height: auto; width: 100%;    padding: 0;">
	<div style="font-size:1.4rem; padding:1.5rem; padding-top:2.5rem;  padding-bottom:0; color:#fbfbfb80;">Messages</div>
	...
	<header id="panel-temperature" class="large-panel-button" style="height: auto; width: 100%;    padding: 0;">
	<div style="font-size:1.4rem; padding:1.5rem; padding-top:2.5rem;  padding-bottom:0; color:#fbfbfb80;">Services</div>
	<div style=" text-align:center; width:100%; font-size:0.7rem; color:#fbfbfbCC;"><div style="padding:1rem; padding-top:0.25rem; padding-bottom:2rem;">Noise</div></div>
	</header>
	
	<header id="panel-temperature" class="large-panel-button" style="height: auto; width: 100%;    padding: 0;">
	<div style="font-size:1.4rem; padding:1.5rem; padding-top:2.5rem;  padding-bottom:0; color:#fbfbfb80;">Optional Services</div>
	<div style=" text-align:center; width:100%; font-size:0.7rem; color:#fbfbfbCC;"><div style="padding:1rem; padding-top:0.25rem; padding-bottom:2rem;">Noise</div></div>
	</header>
